...
static float DSY_SDRAM_BSS buf_d0_2[673];
static float DSY_SDRAM_BSS buf_d0_3[414];
// Diffuser 1 buffers (scaled up)
static float DSY_SDRAM_BSS buf_d1_0[211];
static float DSY_SDRAM_BSS buf_d1_1[157];
static float DSY_SDRAM_BSS buf_d1_2[673];
static float DSY_SDRAM_BSS buf_d1_3[414];
// FDN 8-line buffers
...
void CloudReverb::Init() {
    ...
    const size_t d0_sizes[Diffuser::STAGES] = { 143, 108, 673, 414 };
    ...
    const size_t d1_sizes[Diffuser::STAGES] = { 211, 157, 673, 414 };
